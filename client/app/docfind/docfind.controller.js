...
angular.module('applicationApp')
  .controller('DocFindCtrl', function ($scope, $http, $location, searchService, loginService, docfindService, $state, $timeout) {
    ...
    $scope.auth.loginState = 'docfind.doctor-login';
    $scope.auth.logoutState = 'docfind.home';
